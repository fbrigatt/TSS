...
CREATE TABLE `status_caixa` (
  ...
  `caixas_id` int(11) NOT NULL DEFAULT '0',
  `data_abertura` datetime DEFAULT NULL,
  `data_fechamento` datetime DEFAULT NULL,
  PRIMARY KEY (`id`,`caixas_id`),
  KEY `fk_status_caixa_caixas1_idx` (`caixas_id`),
  CONSTRAINT `fk_status_caixa_caixas1` FOREIGN KEY (`caixas_id`) REFERENCES `caixas` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
