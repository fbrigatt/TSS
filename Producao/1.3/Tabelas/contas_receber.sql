...
CREATE TABLE `contas_receber` (
  ...
  KEY `fk_contas_receber_movimentos1_idx` (`movimentos_id`),
  KEY `fk_contas_receber_formas_pagamento1_idx` (`formas_pagamento_id`),
  CONSTRAINT `fk_contas_receber_formas_pagamento1` FOREIGN KEY (`formas_pagamento_id`) REFERENCES `formas_pagamento` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
  CONSTRAINT `fk_contas_receber_movimentos1` FOREIGN KEY (`movimentos_id`) REFERENCES `movimentos` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION
