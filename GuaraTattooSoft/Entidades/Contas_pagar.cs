...
namespace GuaraTattooSoft.Entidades
{
    class Contas_pagar : IClasse_Persistencia
    {
        ...
        public void Atualizar(int id)
        {
            try
            {
                MySqlCommand cmd = new MySqlCommand("update contas_pagar set movimentos_id = @1, formas_pagamento_id = @2, emitente = @3, destinatario = @4, descricao = @5, valor = @6, vencimento = @7, juros = @8, pago = @9 where id = " + id, conn.GetConexao());
        ...
        public void Gravar()
        {
            try
            {
                MySqlCommand cmd = new MySqlCommand("insert into contas_pagar(movimentos_id, formas_pagamento_id, emitente, destinatario, descricao, valor, vencimento, juros, pago) values(@1, @2, @3, @4, @5, @6, @7, @8, @9)", conn.GetConexao());
